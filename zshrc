...
## fzf (global, cached)
# alias z='cd $(cat /tmp/folders.txt | fzf --reverse --border --preview="ls -al {} --color")'
# alias x='cat /tmp/files.txt | fzf --reverse --border --preview="ls -al {} --color" | xclip -selection c'
# alias c='code $(cat /tmp/files.txt | fzf --reverse --border)'
